## Unicode characters similar between one another
Taken from [http://www.unicode.org/Public/security/latest/confusables.txt](http://www.unicode.org/Public/security/latest/confusables.txt) at May 20, 2017.
...
02CA ;	0027 ;	MA	# ( ˊ → ' ) MODIFIER LETTER ACUTE ACCENT → APOSTROPHE	# →ʹ→→′→
...
114C5 ;	0076 0076 0307 ;	MA	# ( 𑓅 → vv̇ ) TIRHUTA GVANG → LATIN SMALL LETTER V, LATIN SMALL LETTER V, COMBINING DOT ABOVE	# →ẇ→
